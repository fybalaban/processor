...
namespace processor.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to LOAD the register R with the bit pattern found in the
        ...
        /// <summary>
        ///   Looks up a localized string similar to LOAD the register R with the bit pattern XY.
        ...
        /// <summary>
        ///   Looks up a localized string similar to STORE the bit pattern found in register R in the memory
        ...
        /// <summary>
        ///   Looks up a localized string similar to MOVE the bit pattern found in register R to register S.
        ...
        /// <summary>
        ///   Looks up a localized string similar to ADD the bit patterns in registers S and T as though they were two’s complement representations and leave the result in register R. Example: 0x5726 would cause the binary values in registers 0x2 and 0x6 to be added and the sum placed in register 0x7..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to ADD the bit patterns in registers S and T as though they
        ...
        /// <summary>
        ///   Looks up a localized string similar to OR the bit patterns in registers S and T and place the
        ...
        /// <summary>
        ///   Looks up a localized string similar to AND the bit patterns in registers S and T and place the
        ///result in register R.
        ...
        /// <summary>
        ///   Looks up a localized string similar to XOR the bit patterns in registers S and T and place the
        ///result in register R.
        ...
        /// <summary>
        ///   Looks up a localized string similar to ROTATE the bit pattern in register R one bit to the right
        ...
        /// <summary>
        ///   Looks up a localized string similar to JUMP to the instruction located in the memory cell at
        ...
        ///program counter so that the next instructi [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to HALT execution.
